...
util.base64Encode = function(e) {
    ...
    var t = e, n = wx.getStorageSync("userInfo").sessionid;
    if (-1 == t.indexOf("http://") && -1 == t.indexOf("https://") && (t = util.url(t)), 
    getUrlParam(t, "state") || e.data && e.data.state || !n || (t = t + "&state=we7sid-" + n), 
    !e.data || !e.data.m) {
        var a = getCurrentPages();
        a.length && (a = a[getCurrentPages().length - 1]) && a.__route__ && (t = t + "&m=" + a.__route__.split("/")[0]);
    }
    var r = getSign(t, e.data);
    return r && (t = t + "&sign=" + r), t;
