...
var app = new getApp(), conf = {
    ...
    calculateDays: function(a, t) {
        ...
        for (var s = 1; s <= n; s++) {
            ...
            d = new Date(d);
            var c = void 0;
            c = !(0 < r.getTime() - d.getTime()), e.push({
                day: s,
                choosed: !1,
                size: c,
                sign: !1
    ...
    handleCalendar: function(a) {
        ...
        var d = app.globalData.uid, c = app.siteInfo.uniacid, i = this, o = i.data.calendar;
        app.util.request({
    ...
    tapDayItem: function(a) {
        ...
        if ((r = new Date(r)).getTime() - n.getTime() == 0) {
            ...
            var s = this.data.calendar.curYear, d = this.data.calendar.curMonth, c = e[t].day, i = app.globalData.uid, o = app.siteInfo.uniacid, l = this;
            app.util.request({
                url: "entry/wxapp/sign",
                data: {
                    op: "addSign",
